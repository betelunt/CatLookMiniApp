...
const foods = [
  ...
  { id:"a29", name:"BHA", category:"additive", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"人工合成抗氧化剂（防腐）", advice:"不推荐选择含 BHA 的猫粮", warning:"国际癌症研究机构列为可能人类致癌物，多国已禁用" },
  { id:"a30", name:"BHT", category:"additive", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"人工合成抗氧化剂（防腐）", advice:"不推荐选择含 BHT 的猫粮", warning:"与 BHA 同类人工抗氧化剂，安全性存疑" },
  { id:"a31", name:"乙氧基喹啉", category:"additive", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"人工合成抗氧化剂防腐剂", advice:"尽量避免含此成分的猫粮", warning:"潜在肝脏和肾脏毒性，欧盟已限制使用" },
  ...
  { id:"a35", name:"玉米蛋白粉", category:"additive", categoryLabel:"其他", safety:"caution", safetyLabel:"谨慎", nutrition:"植物蛋白来源", effect:"提高猫粮粗蛋白数值（植物蛋白）", advice:"猫更适合动物蛋白，植物蛋白利用率低", warning:"很多劣质猫粮用玉米蛋白粉虚增蛋白质含量，猫实际可利用的动物蛋白不足" },
  ...
  { id:"a42", name:"玉米", category:"grain", categoryLabel:"谷物", safety:"caution", safetyLabel:"谨慎", nutrition:"碳水化合物来源", effect:"提供能量但无必需营养", advice:"猫是肉食动物，谷物含量高的猫粮品质较差", warning:"高碳水可致肥胖和糖尿病；部分猫对玉米过敏" },
  ...
  { id:"a72", name:"洋葱", category:"vegetable", categoryLabel:"蔬菜", safety:"danger", safetyLabel:"危险", nutrition:"含正丙基二硫化物", effect:"破坏红细胞，导致溶血性贫血", advice:"绝对禁止喂食洋葱（包括生、熟、脱水、粉末所有形态）", warning:"极少量即可中毒！症状：呕吐、腹泻、牙龈苍白、虚弱、尿液变色。洋葱粉也含毒性！" },
  { id:"a73", name:"大蒜", category:"vegetable", categoryLabel:"蔬菜", safety:"danger", safetyLabel:"危险", nutrition:"含硫代硫酸盐", effect:"比洋葱毒性强5倍，破坏红细胞", advice:"绝对禁止喂食任何形式的大蒜", warning:"极少量即可中毒！猫对大蒜比狗更敏感" },
  { id:"a74", name:"葱", category:"vegetable", categoryLabel:"蔬菜", safety:"danger", safetyLabel:"危险", nutrition:"含正丙基二硫化物", effect:"与洋葱同类毒性，破坏红细胞", advice:"绝对禁止喂食（大葱、小葱、香葱、韭菜均不可）", warning:"葱属植物全部对猫有毒" },
  { id:"a75", name:"葡萄", category:"fruit", categoryLabel:"水果", safety:"danger", safetyLabel:"危险", nutrition:"对猫有不明毒素", effect:"可导致急性肾衰竭", advice:"绝对禁止喂食（包括葡萄干）", warning:"极少量即可中毒！即使目前未确定毒性物质，但临床案例确凿" },
  { id:"a76", name:"葡萄干", category:"fruit", categoryLabel:"水果", safety:"danger", safetyLabel:"危险", nutrition:"葡萄的浓缩形态，毒性更强", effect:"比葡萄毒性更浓缩，微量即可致肾衰竭", advice:"绝对禁止喂食", warning:"几粒葡萄干就可能致命" },
  { id:"a77", name:"木糖醇", category:"additive", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"人工甜味剂", effect:"导致胰岛素大量释放→严重低血糖→肝损伤", advice:"绝对禁止喂食含木糖醇的任何食品", warning:"极少量(0.1g/kg)即可中毒！常见于无糖口香糖、无糖花生酱、部分牙膏" },
  { id:"a78", name:"巧克力", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"含可可碱和咖啡因", effect:"刺激中枢神经和心血管系统", advice:"绝对禁止喂食（包括白巧克力、可可粉）", warning:"黑巧克力毒性最强，每克黑巧含可可碱约5-15mg，猫致死剂量约200mg/kg" },
  { id:"a79", name:"可可", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"含可可碱和咖啡因", effect:"与巧克力同类毒性", advice:"禁止喂食任何含可可的食品" },
  { id:"a80", name:"咖啡", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"含咖啡因", effect:"刺激中枢神经和心脏", advice:"绝对禁止（包括咖啡豆、咖啡渣、含咖啡因饮料）", warning:"猫对咖啡因比人敏感得多，小剂量即可中毒" },
  { id:"a81", name:"茶", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"含咖啡因+茶碱", effect:"与咖啡因同类毒性", advice:"禁止喂食茶水、茶叶", warning:"包括绿茶、红茶、乌龙茶等所有茶类" },
  { id:"a82", name:"酒精", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"乙醇", effect:"抑制中枢神经，损害肝脏", advice:"绝对禁止任何含酒精的食物饮料", warning:"即使微量酒精也可能导致中毒，含酒甜点也不能喂" },
  { id:"a83", name:"酵母面团", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"生面团在胃里发酵产生酒精+气体", effect:"酒精中毒+胃扩张/肠扭转", advice:"绝对不要让猫咪吃到生面团", warning:"生面团在温暖潮湿的胃里会持续发酵，双重致命" },
  { id:"a84", name:"夏威夷果", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"对犬猫有毒的不明物质", effect:"神经肌肉毒性", advice:"绝对禁止喂食", warning:"症状：虚弱、呕吐、步态不稳、体温升高" },
  { id:"a85", name:"澳洲坚果", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"夏威夷果的别称，毒性相同", advice:"绝对禁止喂食" },
  { id:"a86", name:"味精", category:"additive", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"谷氨酸钠", effect:"高钠，对猫肾脏造成负担", advice:"不要喂食含味精的人类食物" },
  { id:"a87", name:"盐", category:"additive", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"氯化钠", effect:"过量可导致钠离子中毒", advice:"猫粮中极少添加即可，人类食物中的盐分远超出猫的需求", warning:"高盐零食（薯片、肉干等）绝对不能喂猫" },
  { id:"a88", name:"糖", category:"additive", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"纯蔗糖/白砂糖", effect:"猫无法代谢大量糖分，导致肥胖和糖尿病", advice:"猫粮不需要添加糖，高品质猫粮不会含糖" },
  { id:"a89", name:"丙二醇", category:"additive", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"保湿剂/溶剂", effect:"对猫红细胞有毒性", advice:"猫专用食品中不应出现丙二醇，部分劣质湿粮中可能含有", warning:"猫对丙二醇极其敏感，美国已禁止在猫粮中使用" },
  ...
  { id:"a91", name:"维生素K3", category:"additive", categoryLabel:"营养素", safety:"danger", safetyLabel:"危险", nutrition:"人工合成维生素K（甲萘醌）", effect:"高剂量有肝毒性", advice:"避免选择含维生素K3（甲萘醌亚硫酸氢钠）的猫粮", warning:"选择含天然维生素K来源的猫粮" },
  { id:"a92", name:"4D肉", category:"meat", categoryLabel:"肉类", safety:"danger", safetyLabel:"危险", nutrition:"Dead+Dying+Diseased+Disabled 动物肉/副产品", advice:"劣质猫粮才用4D肉，正规品牌不会使用" },
  ...
  // ═══════════════════════════════════════════════════════════
  { id:"x11", name:"酱油", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"高钠+调味料", advice:"不能喂猫，人类调味料对猫有害" },
  { id:"x12", name:"蚝油", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"高钠+调味料", advice:"不能喂猫" },
  { id:"x13", name:"料酒", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"含酒精的烹饪调料", advice:"酒精对猫有毒" },
  { id:"x14", name:"生姜", category:"vegetable", categoryLabel:"蔬菜", safety:"caution", safetyLabel:"谨慎", nutrition:"刺激性食材", advice:"少量存在于猫粮中通常无害，但大量生姜对猫肠胃有刺激" },
  { id:"x15", name:"辣椒", category:"vegetable", categoryLabel:"蔬菜", safety:"danger", safetyLabel:"危险", nutrition:"含辣椒素", advice:"猫咪非常讨厌且对肠胃有刺激" },
  { id:"x16", name:"花椒", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"麻辣调料", advice:"对猫肠胃有强刺激" },
  { id:"x17", name:"胡椒", category:"other", categoryLabel:"其他", safety:"caution", safetyLabel:"谨慎", nutrition:"香辛料", advice:"少量无害，但猫不需要任何调料" },
  { id:"x18", name:"肉桂", category:"other", categoryLabel:"其他", safety:"caution", safetyLabel:"谨慎", nutrition:"香辛料", advice:"少量安全，但大量对猫肝脏有负担" },
  { id:"x19", name:"丁香", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"含丁香酚", advice:"丁香酚对猫有毒，大量可致肝损伤" },
  { id:"x20", name:"肉豆蔻", category:"other", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"含肉豆蔻醚", advice:"对猫神经系统有毒性" },
  { id:"x21", name:"鳄梨", category:"fruit", categoryLabel:"水果", safety:"danger", safetyLabel:"危险", nutrition:"含Persin毒素", advice:"对猫有毒性，可致呕吐腹泻" },
  { id:"x22", name:"牛油果", category:"fruit", categoryLabel:"水果", safety:"danger", safetyLabel:"危险", nutrition:"鳄梨的别名，含Persin", advice:"对猫有毒" },
  { id:"x23", name:"蘑菇", category:"vegetable", categoryLabel:"蔬菜", safety:"caution", safetyLabel:"谨慎", nutrition:"部分品种对猫有毒", advice:"超市常见食用菌少量无害，但绝不喂野蘑菇" },
  { id:"x24", name:"番茄", category:"vegetable", categoryLabel:"蔬菜", safety:"caution", safetyLabel:"谨慎", nutrition:"未成熟番茄含龙葵碱", advice:"成熟红番茄少量安全，但青番茄/叶/茎有毒" },
  { id:"x25", name:"西红柿", category:"vegetable", categoryLabel:"蔬菜", safety:"caution", safetyLabel:"谨慎", nutrition:"番茄的别名", advice:"成熟果实少量安全，青的不可喂" },
  { id:"x26", name:"菠菜", category:"vegetable", categoryLabel:"蔬菜", safety:"caution", safetyLabel:"谨慎", nutrition:"含草酸钙", advice:"少量安全，但泌尿系统有问题的猫咪避免" },
  { id:"x27", name:"芦笋", category:"vegetable", categoryLabel:"蔬菜", safety:"safe", safetyLabel:"安全", nutrition:"含纤维、维生素K", advice:"少量煮熟喂食安全" },
  { id:"x28", name:"芹菜", category:"vegetable", categoryLabel:"蔬菜", safety:"safe", safetyLabel:"安全", nutrition:"低热量高纤维", advice:"少量安全，有些猫咪会啃着玩" },
  { id:"x29", name:"黄瓜", category:"vegetable", categoryLabel:"蔬菜", safety:"safe", safetyLabel:"安全", nutrition:"水分高几乎无热量", advice:"安全，可作为低热量零食" },
  { id:"x30", name:"生菜", category:"vegetable", categoryLabel:"蔬菜", safety:"safe", safetyLabel:"安全", nutrition:"水分高，营养较少", advice:"安全但营养价值很低" },
  { id:"x31", name:"玉米糖浆", category:"additive", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"高果糖甜味剂", advice:"纯糖无任何营养，导致肥胖糖尿病" },
  { id:"x32", name:"果葡糖浆", category:"additive", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"高果糖浆", advice:"猫完全不需要，劣质猫粮中用来增加适口性" },
  { id:"x33", name:"纤维素粉", category:"additive", categoryLabel:"其他", safety:"safe", safetyLabel:"安全", nutrition:"纯纤维素（不可溶纤维）", advice:"少量添加帮助排毛球，但过多是填充物" },
  { id:"x34", name:"蒙脱石", category:"additive", categoryLabel:"其他", safety:"safe", safetyLabel:"安全", nutrition:"天然矿物，抗结块+吸附毒素", advice:"合规添加安全，还有助吸附肠道毒素" },
  { id:"x35", name:"沸石", category:"additive", categoryLabel:"其他", safety:"safe", safetyLabel:"安全", nutrition:"天然矿物抗结块剂", advice:"合规添加安全" },
  { id:"x36", name:"海藻粉", category:"seafood", categoryLabel:"海鲜", safety:"safe", safetyLabel:"安全", nutrition:"微量元素和矿物质来源", advice:"适量安全" },
  { id:"x37", name:"鱼水解蛋白", category:"seafood", categoryLabel:"海鲜", safety:"safe", safetyLabel:"安全", nutrition:"天然鲜味剂+蛋白补充", advice:"安全的天然增味成分" },
  { id:"x38", name:"水解鸡肝", category:"organ", categoryLabel:"内脏", safety:"safe", safetyLabel:"安全", nutrition:"天然鲜味剂", advice:"安全的天然增味成分" },
  { id:"x39", name:"水解鸡肉", category:"meat", categoryLabel:"肉类", safety:"safe", safetyLabel:"安全", nutrition:"天然鲜味剂+蛋白肽", advice:"安全的天然调味蛋白来源" },
  { id:"x40", name:"鸡骨", category:"meat", categoryLabel:"肉类", safety:"danger", safetyLabel:"危险", nutrition:"不可消化", advice:"煮熟的骨头会碎裂，刺伤食道和肠道！" },
  { id:"x41", name:"鱼骨", category:"seafood", categoryLabel:"海鲜", safety:"danger", safetyLabel:"危险", nutrition:"不可消化", advice:"鱼刺/鱼骨可能卡住喉咙或刺伤消化道" },
  { id:"x42", name:"麦芽糖", category:"additive", categoryLabel:"其他", safety:"caution", safetyLabel:"谨慎", nutrition:"双糖甜味剂", advice:"猫不需要糖分，少量无害但纯属多余" },
  { id:"x43", name:"葡萄糖", category:"additive", categoryLabel:"其他", safety:"caution", safetyLabel:"谨慎", nutrition:"单糖", advice:"猫不需要额外添加糖分" },
  { id:"x44", name:"果糖", category:"additive", categoryLabel:"其他", safety:"caution", safetyLabel:"谨慎", nutrition:"单糖", advice:"猫对果糖代谢能力差" },
  { id:"x45", name:"蔗糖", category:"additive", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"白砂糖/红糖的总称", advice:"猫粮不需要添加蔗糖" },
  { id:"x46", name:"红糖", category:"additive", categoryLabel:"其他", safety:"danger", safetyLabel:"危险", nutrition:"蔗糖的一种", advice:"不能喂猫" },
  { id:"x47", name:"蜂蜜", category:"additive", categoryLabel:"其他", safety:"caution", safetyLabel:"谨慎", nutrition:"果糖+葡萄糖", advice:"极少量无害但猫不需要，且可能含肉毒杆菌孢子" },
  { id:"x48", name:"乳糖", category:"dairy", categoryLabel:"乳制品", safety:"caution", safetyLabel:"谨慎", nutrition:"乳中的糖", advice:"多数成年猫乳糖不耐受，可致腹泻" },
  { id:"x49", name:"全脂奶粉", category:"dairy", categoryLabel:"乳制品", safety:"caution", safetyLabel:"谨慎", nutrition:"乳制品", advice:"多数成年猫乳糖不耐受" },
  { id:"x50", name:"脱脂奶粉", category:"dairy", categoryLabel:"乳制品", safety:"caution", safetyLabel:"谨慎", nutrition:"乳制品（乳糖仍在）", advice:"同样含乳糖，不能解决不耐受问题" },
  { id:"x51", name:"奶酪", category:"dairy", categoryLabel:"乳制品", safety:"caution", safetyLabel:"谨慎", nutrition:"高脂高盐乳制品", advice:"极少量偶尔作为零食可能安全，但多数猫消化乳制品有问题" },
  { id:"x52", name:"黄油", category:"dairy", categoryLabel:"乳制品", safety:"danger", safetyLabel:"危险", nutrition:"纯乳脂肪", advice:"高脂高热量，可引发胰腺炎" },
  { id:"x53", name:"奶油", category:"dairy", categoryLabel:"乳制品", safety:"danger", safetyLabel:"危险", nutrition:"高脂乳制品", advice:"多数猫乳糖不耐受+高脂肪" },
  { id:"x54", name:"牛奶", category:"dairy", categoryLabel:"乳制品", safety:"caution", safetyLabel:"谨慎", nutrition:"含乳糖", advice:"多数成年猫乳糖不耐受，会导致腹泻", warning:"幼猫断奶后乳糖酶活性迅速下降" },
  { id:"x55", name:"鸡蛋", category:"meat", categoryLabel:"肉类", safety:"safe", safetyLabel:"安全", nutrition:"优质完全蛋白，含卵磷脂", effect:"优质蛋白质来源", advice:"必须完全煮熟后喂食，不能喂生鸡蛋", warning:"生蛋清含抗生物素蛋白，影响生物素吸收；生鸡蛋可能有沙门氏菌" },
  { id:"x56", name:"蛋黄", category:"meat", categoryLabel:"肉类", safety:"safe", safetyLabel:"安全", nutrition:"含卵磷脂、胆碱、维A维D", effect:"美毛护肤", advice:"煮熟后少量喂食，每周1-2个蛋黄即可", warning:"不要喂生蛋黄（沙门氏菌风险）" },
  { id:"x57", name:"蛋清", category:"meat", categoryLabel:"肉类", safety:"safe", safetyLabel:"安全", nutrition:"纯蛋白质", advice:"必须煮熟！生蛋清含抗生物素蛋白有害", warning:"生蛋清会导致生物素缺乏症" },
  { id:"x58", name:"面包", category:"grain", categoryLabel:"谷物", safety:"caution", safetyLabel:"谨慎", nutrition:"精制碳水+可能含盐糖", advice:"猫不需要，偶尔极少量无害但没有任何好处" },
  { id:"x59", name:"面条", category:"grain", categoryLabel:"谷物", safety:"caution", safetyLabel:"谨慎", nutrition:"纯碳水", advice:"猫不需要" },
  { id:"x60", name:"米饭", category:"grain", categoryLabel:"谷物", safety:"caution", safetyLabel:"谨慎", nutrition:"精制碳水", advice:"少量无害但猫不需要，高碳水饮食不健康" },
